...
- [ ] **FB-05**: User can post markdown-formatted comments on any feedback item. Comments are timestamped, linked to author, and appear in chronological order in the detail view.
